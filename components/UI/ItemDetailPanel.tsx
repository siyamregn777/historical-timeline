...
const ItemDetailPanel: React.FC<Props> = ({ item, categories, lang, onClose, onLearnMore }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 sm:p-6 pointer-events-none">
      ...
      <div className={`relative w-full max-w-xl bg-white rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-300 pointer-events-auto`}>
